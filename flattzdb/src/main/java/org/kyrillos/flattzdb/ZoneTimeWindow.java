...
public final class ZoneTimeWindow extends Table {
  ...
  public Time fixed() { return fixed(new Time()); }
  public Time fixed(Time obj) { int o = __offset(8); return o != 0 ? obj.__init(o + bb_pos, bb) : null; }
  ...
  public static void startZoneTimeWindow(FlatBufferBuilder builder) { builder.startObject(6); }
  ...
  public static void addFixed(FlatBufferBuilder builder, int fixedOffset) { builder.addStruct(2, fixedOffset, 0); }
